...
public class LlmPromptExecutionHandler {
    ...
    public RunResult execute(SkillManifest manifest, JsonNode input) {
        ...
        ModelRequest request = buildModelRequest(manifest, input);
    ...
    private ModelRequest buildModelRequest(SkillManifest manifest, JsonNode input) {
        ...
        request.setTemperature(0.1); // Default conservative temperature
