...
public class ExecutionTrace {
    ...
    public void setPipelineSteps(List<PipelineStepTrace> steps) { this.pipelineSteps = steps; }
    ...
    public void setSkillInvocations(List<SkillInvocationTrace> invocations) { this.skillInvocations = invocations; }

    public void addSkillInvocation(SkillInvocationTrace skill) { this.skillInvocations.add(skill); }
