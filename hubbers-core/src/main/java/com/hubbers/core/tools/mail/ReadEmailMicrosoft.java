...
@Slf4j
public class ReadEmailMicrosoft extends Tool {
	
	ExchangeService service;
	ExchangeCredentials credentials;
	
	@Builder
	public ReadEmailMicrosoft() throws URISyntaxException {
		
		service = new ExchangeService(ExchangeVersion.Exchange2010_SP2);
    	credentials = new WebCredentials("xxxxx", "xxxx");
    	service.setCredentials(credentials);
    	service.setUrl(new URI("yyyy"));
	}
